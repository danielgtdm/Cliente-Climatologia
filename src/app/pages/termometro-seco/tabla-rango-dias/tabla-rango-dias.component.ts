...
export class TablaRangoDiasComponent implements OnInit {
  ...
  private viewDataTable(listaRegistros: Registro[]) {
    ...
    for (let i = 0; i < registros.length; i++) {
      ...
      data.push({
        'Fecha': fecha,
        '08:30 hrs': termometroSeco.h0830 != null ? `${termometroSeco.h0830}` : 'No Registrado',
        '14:00 hrs': termometroSeco.h1400 != null ? `${termometroSeco.h1400}` : 'No Registrado',
        '18:00 hrs': termometroSeco.h1800 != null ? `${termometroSeco.h1800}` : 'No Registrado'
      });
    }
